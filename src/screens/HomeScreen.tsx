...
const styles = StyleSheet.create({
  ...
  navLink: { color: "#687085", fontSize: 13, fontWeight: "600" },
  ...
  progressPercent: { color: "#F6A56D", fontSize: 16, fontWeight: "900" },
  progressTrack: { backgroundColor: "#4B5265", borderRadius: 5, height: 7, marginTop: 14 },
  progressFill: { backgroundColor: "#F28A4A", borderRadius: 5, height: 7, width: "78%" },
  progressHint: { color: "#DDE0E7", fontSize: 10, marginTop: 12 },
  coachCard: { alignItems: "center", backgroundColor: "#FFF2E8", borderRadius: 15, flexDirection: "row", marginTop: 13, padding: 13 },
  coachIcon: { alignItems: "center", backgroundColor: "#F28A4A", borderRadius: 18, height: 36, justifyContent: "center", marginRight: 10, width: 36 },
